  ...
  return (
    <Card sx={{ width: 400, height: 500 }}>
      <Box sx={{ display: "flex", flexDirection: "column", p: 2 }}>
        ...
        <Typography
          sx={{ alignSelf: "center", ml: 1, mb: 2, cursor: "pointer" }}
          variant="caption"
          onClick={() => {
...
function Signup() {
  const mutation = useMutation({
    ...
    onSuccess: () => {
      if (debug === true) alert("User successfully added a user!");
    },
  });
  ...
  return (
    ...
    >
      ...
      <InputLabel htmlFor="confirm_password_signup">
        Confirm password
      </InputLabel>
      <Input
